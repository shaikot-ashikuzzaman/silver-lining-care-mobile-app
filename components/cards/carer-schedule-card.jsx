    ...
    return (
        ...
        >
            ...
            <View className="p-4" style={{ flex: 2 }}>
                ...
                <View className="flex-row items-center gap-1 mt-2">
                    <Icon name={ICONS_NAME.home} color="#14b8a6" size={13} />
                    <Typography variant="small1" className="text-neutral-500 leading-snug">
                        {address}
                    </Typography>
...
export default CarerScheduleCard;
